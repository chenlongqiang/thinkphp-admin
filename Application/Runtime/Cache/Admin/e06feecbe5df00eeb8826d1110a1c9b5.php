        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="<?php echo U('System/adminRoleEdit');?>" method="post">
                            ...
                            <table class="table table-hover table-bordered">
                                <tbody>
                                    <tr>
                                        ...
                                        <input name="val[admin_id]" type="hidden" value="<?php echo ($input_data["admin_id"]); ?>">
                                    </tr>
                                    <tr>
                                        <td>角色: </td>
                                        <td>
                                            <!-- todo 全选,子菜单先择 js-->
                                            <?php if(is_array($role_list)): $i = 0; $__LIST__ = $role_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><p>
                                                    <label>
                                                        <input name="val[role_id][]" type="checkbox" value="<?php echo ($value["id"]); ?>" <?php echo (input_checked($role_ids,$value[id])); ?>> <?php echo ($value["name"]); ?>
                                                    </label>
