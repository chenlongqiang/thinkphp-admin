        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-heading clearfix">
                    <form class="form-inline pull-left" role="form" action="/Admin/System/roleList.html" id="form_filter" method="post">
                        <div class="form-group">
                            <label class="sr-only"></label>
                            <select class="form-control" name="filter[option]">
                                <option value="name" <?php echo (option_selected($filter[option],"name")); ?>>角色名</option>
                            ...
                            <tbody>
                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td style="text-align: center">
                                            <a href="#edit_role_layer" data-toggle="modal" data-id="<?php echo ($value["id"]); ?>" data-name="<?php echo (hs($value["name"])); ?>" data-note="<?php echo (hs($value["note"])); ?>" data-type="edit" class="btn btn-xs btn-primary">编辑</a>
                                            <a href="<?php echo U('System/roleMenuList', array('role_id' => $value[id], 'name' => $value[name]));?>" class="btn btn-xs btn-primary">角色授权</a>
                                            <button type="button" data-href="<?php echo U('System/roleDelete', array('id' => $value[id]));?>" class="delete_confirm btn btn-xs btn-danger" data-toggle="modal" data-target="#common_confirm_modal">删除</button>
                                        </td>
    ...
    <div class="modal fade" id="edit_role_layer" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?php echo U('System/roleEdit');?>" class="form-horizontal" method="post">
