...
class WechatService
{
    ...
    const MSG_TYPE_CUSTOMER_SERVICE = 'transfer_customer_service';
    ...
    const MSG_EVENT_KFCREATESESSION = 'kf_create_session';
    const MSG_EVENT_KFCLOSESESSION = 'kf_close_session';
    const MSG_EVENT_KFSWITCHSESSION = 'kf_switch_session';
    ...
    /**
     * 构造音乐信息
     * @param $music 要回复的音乐[标题，说明，链接，高品质链接，缩略图ID]
     * @return array
     */
    ...
    private static function transfer_customer_service($transInfo)
    {
    ...
    private static function extract($encrypt)
    {
        ...
        //消息解密对象
        $WeChatCrypt = new WechatCryptService(self::$encodingAESKey, self::$appId);
